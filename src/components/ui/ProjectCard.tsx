...
// interface ProjectCardProps {
//   project: Project;
//   activeCategory: string;  // Pass the activeCategory from the parent component
// }

// const ProjectCard: React.FC<ProjectCardProps> = ({ project, activeCategory }) => {
//   return (
//     <motion.div
//       className="relative group overflow-hidden rounded-xl bg-gray-900 shadow-xl h-full"
//       initial={{ opacity: 0, y: 20 }}
...
//           {activeCategory === project.category && (  // Only show the category if it matches the active category
